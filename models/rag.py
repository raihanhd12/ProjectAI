...
class StreamlinedRAG:
        ...
        try:
            ...
            for doc in docs:
                ...
                doc.metadata.update({
                    ...
                    "date_processed": os.path.getctime(temp_file.name)
                })
    ...
    def re_rank_documents(self, query: str, documents, top_k: int = 3):
        """
    ...
    def query_with_sources(self, query_text: str):
        """
    ...
    def _call_llm(self, context: str, prompt: str):
        """
